...
const BillingOptBuyBackNew = (props) => {
  const {
    checkBoxLabel,
    isBuyBackChecked,
    optBuyBackSubtext,
          ...
          <div className="vida-billing-buy-back__checkbox form__group form__field-checkbox">
            <label className="vida-user-access__label">
              ...
              <input
                ...
                // ref={setCheckboxRef}
                onChange={(e) => handleBuyBackChange(e)}
              />
...
BillingOptBuyBackNew.propTypes = {
  checkBoxLabel: PropTypes.string,
  optBuyBackSubtext: PropTypes.string,
  isBuyBackChecked: PropTypes.bool,
...
export default BillingOptBuyBackNew;
